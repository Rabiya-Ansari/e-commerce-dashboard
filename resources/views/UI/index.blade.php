            ...
            <div class="swiper-wrapper">
              @foreach ($data as $value)
                <a href="index.html" class="nav-link category-item swiper-slide">
                  ...
                  <h3 class="category-title">{{$value['categories_name']}}</h3>
                  <h3 class="category-title">{{$value['category_description']}}</h3>
                  ...
                  @foreach ($data as $value)
                    <div class="col">
                      <div class="product-item">
                        ...
                        <span class="qty">{{$value['detail']}}</span><span class="rating"><svg width="24" height="24"
                            class="text-primary">
